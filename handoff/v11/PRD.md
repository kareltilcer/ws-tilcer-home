...
> Companion spec: `openapi.yaml` (OpenAPI 3.1 — **0.15.0 = v11, the MCP token management surface**; **0.14.0 is what is DEPLOYED** and is v10.2-era, adding the same-day reminder lead `"0d"`; 0.13.0 was v10.1, 0.12.2 the cursor encoding, 0.12.1 the v10 as-built reconciliation, 0.12.0 the v10 spec, 0.11.0 v9 as built) — this file is a copy of the served `backend/openapi.yaml`, so the v7/v8 drift cannot repeat. ⚠ **The MCP surface itself is NOT in `openapi.yaml` and cannot be** (D320): it is JSON-RPC with a JSON Schema per tool, and its contract is `backend/mcp-manifest.json`, generated by `internal/arch`'s completeness test and committed. · Notes: `notes.md` · Design brief: `HANDOFF-design.md` (v2–**v11** addenda) · Build: `HANDOFF-1…13-*.md` (v9 = `HANDOFF-11-privacy-storage.md`, v10 = `HANDOFF-12-chat.md`, **v11 = `HANDOFF-13-mcp.md`**) · v11 scope brief: `V11-MCP-brief.md` (frozen 2026-09-06)
>
