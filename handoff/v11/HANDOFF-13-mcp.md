...
- Results are capped at `HOME_MCP_MAX_RESULT_KB` **by the host**, not by each provider (D307): a cap eleven providers must remember is a cap that is wrong in at least one of them. Truncation is **stated in the result**, never silent.
