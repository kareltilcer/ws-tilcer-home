...
>
> **Index status (2026-09-06): v6 through v10.2 are all BUILT AND LIVE.** Home runs **eleven** modules on the DEPLOYED **OpenAPI 0.14.0**. **v11 is building: PR 1 of 3 is merged** and moves the repository's contract to **0.15.0**, which reaches the droplet on the next Coolify build of `main` — see the v11 entry below.
>
