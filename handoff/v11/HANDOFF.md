...
>
> **Index status (2026-09-06): v6 through v10.2 are all BUILT AND LIVE.** Home runs **eleven** modules on the served **OpenAPI 0.14.0**. **v11 is specified and not built** — see the v11 entry below.
>
