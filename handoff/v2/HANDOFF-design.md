...
>
> Status: v1 brief issued 2026-07-19; **v2 addendum required (§ v2 at the end) — 2026-07-21.** Owner: Karel · Precedes implementation (Claude Code) — design informs the build, not the other way round.
>
> **The body of this brief describes the v1 four-module design (delivered and approved). v2 changes two things — login is now home-hosted, and Nástěnka is a widget host — which need new screens. See the `## v2 addendum` section at the end before starting; where it conflicts with the v1 body, v2 wins.**
