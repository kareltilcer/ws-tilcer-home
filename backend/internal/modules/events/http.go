...
func (h *Handler) create(w http.ResponseWriter, r *http.Request) {
	...
	httpx.Respond(w, http.StatusCreated, e, err)
}
...
func (h *Handler) occurrences(w http.ResponseWriter, r *http.Request) {
	...
	httpx.Respond(w, http.StatusOK, months, err)
}

func (h *Handler) get(w http.ResponseWriter, r *http.Request) {
	e, err := h.svc.GetEvent(r.Context(), chi.URLParam(r, "id"))
	httpx.Respond(w, http.StatusOK, e, err)
}
...
func (h *Handler) delete(w http.ResponseWriter, r *http.Request) {
	httpx.NoContent(w, h.svc.DeleteEvent(r.Context(), chi.URLParam(r, "id"), boolParam(r, "hard")))
}
...
func (h *Handler) deleteLink(w http.ResponseWriter, r *http.Request) {
	httpx.NoContent(w, h.svc.DeleteLink(r.Context(), chi.URLParam(r, "id")))
}
